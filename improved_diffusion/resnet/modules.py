...
class GDC(nn.Module):
    def __init__(self, in_channels, out_channels, input_size=[14,14]):
        ...
        self.conv2 = vlops.ConvModule(out_channels, out_channels, groups=out_channels, padding=0,
                #kernel_size=input_size[0], act_layer=None, bias=None) #qat
                kernel_size=input_size[0], act_layer=None, bias=False)
        #self.conv3 = vlops.ConvModule(out_channels, out_channels, kernel_size=1, act_layer=None)
        self.conv3 = vlops.ConvModule(out_channels, out_channels, kernel_size=1, act_layer=None, bias=None) #qat
